...
1. Что для вас в приоритете (оцените) ? ### Вопросы с оценкой задавай по одному по очереди
...
2. Сколько человек работает в вашей компании и чем она занимается?

3. А какие процессы, по вашему мнению, вы хотели бы оптимизировать с помощью ИИ?
---
